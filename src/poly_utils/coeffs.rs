...
mod tests {
    ...
    #[test]
    fn test_evaluate_at_univariate_degree_one_manual_computation() {
        // Polynomial: f(x) = 3 + 4x
        let c0 = F::from(3);
        let c1 = F::from(4);
    ...
    #[test]
    fn test_evaluate_at_univariate_degree_three_multiple_points_manual() {
    ...
    #[test]
    fn test_evaluate_at_univariate_equivalence_to_multilinear_manual() {
